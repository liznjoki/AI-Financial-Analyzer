...
def load_page():
    ...
    uploaded_file = st.file_uploader("""Please upload your bank statement with Date, Description, Payments and Deposits Columns. Don't worry we will not save any information 
